...
import serial
import numpy as np
from steadylab.msg import ReadCar, WriteCar
...
class SerialNode(Node):
    def __init__(self):
        ...
        self.serial_pub = self.create_publisher(ReadCar, "read_car", 1)
        self.serial_sub = self.create_subscription(WriteCar, "write_car", self.write_callback, 1)
